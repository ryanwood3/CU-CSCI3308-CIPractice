...
Suite* coord_2d_suite(void)
{
	...
	TCase* tc_2d_area1 = tcase_create("coord_2d_area_triangle1");
    tcase_add_test(tc_2d_area1, test_2d_area1);    

	TCase* tc_2d_area2 = tcase_create("coord_2d_area_triangle2");
    tcase_add_test(tc_2d_area2, test_2d_area2);

    /* Add Cases to Suite */
    suite_add_tcase(s, tc_2d_eq);
    suite_add_tcase(s, tc_2d_dist);
    suite_add_tcase(s, tc_2d_midpoint);
    suite_add_tcase(s, tc_2d_area1);
    suite_add_tcase(s, tc_2d_area2);
